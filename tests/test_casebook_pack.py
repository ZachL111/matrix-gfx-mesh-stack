"""Regression checks for the matrix-gfx-mesh-stack casebook."""
...
from casebook.harness import assert_expected, matrix_gfx_mesh_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(matrix_gfx_mesh_stack_summary(), assert_expected())
