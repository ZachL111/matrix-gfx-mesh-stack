...
$repo = "matrix-gfx-mesh-stack"
$language = "Dart"
$category = "Graphics"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/matrix-gfx-mesh-walkthrough.md")) {
